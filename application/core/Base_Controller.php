 ...
 * in the HMVC style. For more details on the HMVC code used in Racik, see:
 * https://bitbucket.org/wiredesignz/codeigniter-modular-extensions-hmvc/wiki/Home
 *
 * @package Racik\Application\Core\Base_Controller
 */
class Base_Controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        // Because this may be overloaded in someone's custom controllers.
