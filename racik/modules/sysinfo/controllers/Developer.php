 ...
 * 
 * Menampilkan Berbagai Informasi sistem kepada pengguna.
 */
class Developer extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->auth->restrict('Racik.Sysinfo.View');
    ...
    /**
     * Display the system information, including Racik and PHP versions.
     *
     * @return void
     */
    public function index()
    {
        ...
        $dateFormat = 'g:i a';
        $data = array(
            'sysinfo_version_rp'   => RACIK_VERSION,
        ...
        $this->config->load('install/install_check', true, true);
    ...
    /**
     * Display the list of modules in the Racik installation.
     *
     * @return void
     */
     ...
     * of Racik, we can't expect to be able to load it and use the method from
     * there.
     *
