    ...
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        <fieldset>
            ...
            <div class="description control-group<?php echo form_error('description') ? ' error' : ''; ?>">
                <label class="control-label" for="description"><?php echo lang('rp_description'); ?></label>
                <div class="controls">
        ...
        <fieldset class="form-actions">
            ...
            <?php
            echo lang('rp_or') . ' ' . anchor(SITE_AREA . '/settings/roles', lang('rp_action_cancel'));
            if (isset($role)
                && $role->can_delete == 1
