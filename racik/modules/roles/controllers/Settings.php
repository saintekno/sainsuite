 ...
 *
 * Allows the management of the Racik roles.
 */
class Settings extends Admin_Controller
{
    private $permissionContext = 'Site.Settings.View';
    private $permissionCreate = 'Racik.Roles.Add';
    private $permissionEdit = 'Racik.Roles.Manage';
    private $permissionView = 'Racik.Roles.View';
    ...
    public function create()
    {
        ...
        if (! class_exists('Contexts', false)) {
            $this->load->library('display/contexts');
        }
    ...
    public function edit()
    {
        ...
        $title = lang('rp_action_edit') . ' ' . lang('matrix_role');
