...
$lang['ui_keyboard_shortcuts'] = "Keyboard shortcuts are setup in the application config (the 'display.current_shortcuts' key in /application/config/application.php).<br />The currently available shortcuts are:";
...
$lang['ui_default_title'] = 'UI Settings';

$lang['form_validation__validate_shortcuts'] = 'Spaces are not allowed in the shortcut keys';
$lang['form_validation_ui_shortcuts']        = 'Shortcut Key';
$lang['form_validation_ui_actions']          = 'Action';
