<div class="admin-box backup">
    ...
    ?>
            ...
            <div class="control-group<?php echo form_error('drop_tables') ? ' error' : ''; ?>">
                ...
                <div class="controls">
                    <select name="drop_tables" id="drop_tables">
                        <option value="0" <?php echo set_select('drop_tables', '0'); ?>><?php echo lang('rp_no'); ?></option>
                        <option value="1" <?php echo set_select('drop_tables', '1'); ?>><?php echo lang('rp_yes'); ?></option>
                    </select>
            ...
            <div class="control-group<?php echo form_error('add_inserts') ? ' error' : ''; ?>">
                ...
                <div class="controls">
                    <select name="add_inserts" id="add_inserts">
                        <option value="0" <?php echo set_select('add_inserts', '0'); ?>><?php echo lang('rp_no'); ?></option>
                        <option value="1" <?php echo set_select('add_inserts', '1', true); ?>><?php echo lang('rp_yes'); ?></option>
                    </select>
            ...
            <div class="control-group<?php echo form_error('file_type') ? ' error' : ''; ?>">
                ...
                <div class="controls">
                    <select name="file_type" id="file_type">
                        <option value="txt" <?php echo set_select('file_type', 'txt', true); ?>><?php echo lang('rp_none'); ?></option>
        ...
        <fieldset class="form-actions">
            ...
            <?php echo ' ' . lang('rp_or') . ' ' . anchor(SITE_AREA . '/developer/database', lang('rp_action_cancel')); ?>
        </fieldset>
    <?php
        echo form_close();
    endif;
