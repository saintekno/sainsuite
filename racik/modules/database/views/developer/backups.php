        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th><?php echo lang('rp_action_download'); ?></th>
                    <th><?php echo lang('database_restore'); ?></th>
                    <th id='db_size_column'><?php echo lang('rp_size'); ?></th>
                </tr>
            </thead>
            <tfoot>
                <tr>
                    <td colspan="<?php echo $numColumns; ?>">
                        ...
                        <button type="submit" name="delete" class="btn btn-danger" onclick="return confirm('<?php e(js_escape(lang('database_backup_delete_confirm'))); ?>')"><?php echo lang('rp_action_delete'); ?></button>
                    </td>
                </tr>
            </tfoot>
            <tbody>
