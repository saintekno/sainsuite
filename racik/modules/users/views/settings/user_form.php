...
?>
    ...
    if ($canManageUser && $this->auth->has_permission('Racik.Roles.Manage')) :
    ?>
    <fieldset>
    ...
    <fieldset class="form-actions">
        <input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('rp_action_save') . ' ' . lang('rp_user'); ?>" />
        <?php echo lang('rp_or') . ' ' . anchor(SITE_AREA . '/settings/users', lang('rp_action_cancel')); ?>
    </fieldset>
<?php
echo form_close();
