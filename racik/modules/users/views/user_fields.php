...
<div class="control-group<?php echo form_error('email') ? $errorClass : ''; ?>">
    <label class="control-label required" for="email"><?php echo lang('rp_email'); ?></label>
    <div class="controls">
...
<div class="control-group<?php echo form_error('display_name') ? $errorClass : ''; ?>">
    <label class="control-label" for="display_name"><?php echo lang('rp_display_name'); ?></label>
    <div class="controls">
...
<div class="control-group<?php echo form_error('username') ? $errorClass : ''; ?>">
    <label class="control-label required" for="username"><?php echo lang('rp_username'); ?></label>
    <div class="controls">
...
<div class="control-group<?php echo form_error('password') ? $errorClass : ''; ?>">
    <label class="control-label<?php echo $registerClass; ?>" for="password"><?php echo lang('rp_password'); ?></label>
    <div class="controls">
...
<div class="control-group<?php echo form_error('pass_confirm') ? $errorClass : ''; ?>">
    <label class="control-label<?php echo $registerClass; ?>" for="pass_confirm"><?php echo lang('rp_password_confirm'); ?></label>
    <div class="controls">
...
<div class="control-group<?php echo form_error('language') ? $errorClass : ''; ?>">
    <label class="control-label required" for="language"><?php echo lang('rp_language'); ?></label>
    <div class="controls">
...
<div class="control-group<?php echo form_error('timezones') ? $errorClass : ''; ?>">
    <label class="control-label required" for="timezones"><?php echo lang('rp_timezone'); ?></label>
    <div class="controls">
        <?php
        echo timezone_menu(
