 ...
 * Users Controller.
 *
 * Provides front-end functions for users, 
 * including access to login and logout.
 *
 * @package Racik\Modules\Users\Controllers\Users
 */
class Users extends Front_Controller
{
    ...
    public function forgot_password()
    {
        ...
        if (isset($_POST['send'])) {
            ...
            $this->form_validation->set_rules('email', 'lang:rp_email', 'required|trim|valid_email');
    ...
    public function reset_password($email = '', $code = '')
    {
        ...
        // racik may have stored the email and code in the session.
        ...
        if (isset($_POST['set_password'])) {
                $this->form_validation->set_rules('password', 'lang:rp_password', 'required|max_length[120]|valid_password');
                $this->form_validation->set_rules('pass_confirm', 'lang:rp_password_confirm', 'required|matches[password]');
    ...
    private function saveUser($type = 'insert', $id = 0, $metaFields = array())
    {
        ...
        $this->form_validation->set_rules('username', 'lang:rp_username', "{$usernameRequired}trim|max_length[30]|unique[users.username{$extraUniqueRule}]");
        $this->form_validation->set_rules('email', 'lang:rp_email', "required|trim|valid_email|max_length[254]|unique[users.email{$extraUniqueRule}]");
