...
class Settings extends Admin_Controller
{
    ...
    private $permissionCreate = 'Racik.Users.Add';
    private $permissionManage = 'Racik.Users.Manage';
    private $permissionView   = 'Racik.Users.View';
    ...
    private function setUserStatus($userId = false, $status = 1, $suppressEmail = 0)
    {
        ...
        if ($status == 1) {
            $result = $this->user_model->admin_activation($userId);
                $type = lang('rp_action_activate');
        } else {
            $result = $this->user_model->admin_deactivation($userId);
                $type = lang('rp_action_deactivate');
            }
