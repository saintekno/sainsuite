 ...
 *
 * Originally written by Solar Designer <solar at openwall.com> in 2004-2006 and
 * placed in the public domain. Revised in subsequent years, still public domain.
 *
 ...
 *  - Remove support for PHP 4
 *  - Update code to use visibility modifiers and PHP 5 constructor
 *
 * @package Racik\Modules\Users\Libraries\PasswordHash
...
class PasswordHash
{
     ...
     * Constructor
     *
     * @param integer $iteration_count_log2 The number of iterations to use when
     * hashing passwords.
     * @param boolean $portable_hashes      Whether the "portable" hashing algorithm
     * should be used.
     *
     * @return void
     */
    ...
    protected function crypt_private($password, $setting)
    {
        ...
        // primitive available in all versions of PHP currently in use. To implement
    ...
    protected function gensalt_extended($input)
    {
        ...
        // This should be odd to not reveal weak DES keys, and the maximum valid
        // value is (2**24 - 1) which is odd anyway.
    ...
    {
        // This one needs to use a different order of characters and a different
        // encoding scheme from the one in encode64() above. We care because the
        // last character in our encoded string will only represent 2 bits. While
        // two known implementations of bcrypt will happily accept and correct a
        // salt string which has the 4 unused bits set to non-zero, we do not want
        // to take chances and we also do not want to waste an additional byte of
        // entropy.
