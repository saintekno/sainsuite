 ...
 *
 * @package Racik\Modules\Users\Models\User_model
 */
class User_model extends RP_Model
{
    ...
    protected $validation_rules = [
        [
            'field' => 'password',
            'label' => 'lang:rp_password',
            'rules' => 'max_length[120]|valid_password|matches[pass_confirm]',
        ],
        [
            'field' => 'pass_confirm',
            'label' => 'lang:rp_password_confirm',
            'rules' => '',
        ],
        [
            'field' => 'display_name',
            'label' => 'lang:rp_display_name',
            'rules' => 'trim|max_length[255]',
        ],
        [
            'field' => 'language',
            'label' => 'lang:rp_language',
            'rules' => 'required|trim',
        ],
        [
            'field' => 'timezones',
            'label' => 'lang:rp_timezone',
            'rules' => 'required|trim|max_length[40]',
        ],
        [
            'field' => 'username',
            'label' => 'lang:rp_username',
    ...
    //--------------------------------------------------------------------------
    // Other RP_Model Method Overrides.
    //--------------------------------------------------------------------------
    ...
    {
        // Take advantage of RP_Model's prep_data() method.
