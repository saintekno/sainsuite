...
<div class="admin-box">
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th class="id_column"><?php echo lang('rp_id'); ?></th>
        ...
        <fieldset class="form-actions">
            ...
            <?php echo ' ' . lang('rp_or') . ' ' . anchor(SITE_AREA . '/settings/emailer/queue', lang('rp_action_cancel'), 'class="btn btn-warning"'); ?>
        </fieldset>
        <?php endif; ?>
    <?php echo form_close(); ?>
</div>