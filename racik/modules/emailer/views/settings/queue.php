        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th class="preview"><?php echo lang('rp_action_preview'); ?></th>
                </tr>
            </thead>
            <tfoot>
                <tr>
                    <td colspan="<?php echo $numColumns; ?>">
                        <?php echo lang('rp_with_selected') . '&nbsp;'; ?>
                        <button type="submit" name="delete" id="delete-me" class="btn btn-danger" onclick="return confirm('<?php e(js_escape(lang('emailer_delete_confirm'))); ?>')">
                            <span class="icon-white icon-trash"></span> <?php echo lang('rp_action_delete'); ?>
                        </button>
                    </td>
                </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="sent"><?php echo $email->success ? lang('rp_yes') : lang('rp_no'); ?></td>
                    <td class="preview"><?php echo anchor(SITE_AREA . "/settings/emailer/preview/{$email->id}", lang('rp_action_preview'), array('target'=>'_blank')); ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
