...
<!-- Core -->
<div class="admin-box">
    <h3><?php echo lang('translate_core'); ?> <span class="subhead"><?php echo count($lang_files) . ' ' . lang('rp_files'); ?></span></h3>
    <?php
...
<!-- Modules -->
<div class="admin-box">
    <h3><?php echo lang('translate_modules').((! empty($modules) && is_array($modules))?' <span class="subhead">'.count($modules).' '.lang('rp_files').'</span>':''); ?></h3>
    <?php
