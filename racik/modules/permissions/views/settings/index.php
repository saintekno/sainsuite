			...
			<tfoot>
				<tr>
					<td colspan="<?php echo $num_columns; ?>">
						...
						<input type="submit" name="delete" class="btn btn-danger" id="delete-me" value="<?php echo lang('rp_action_delete') ?>" onclick="return confirm('<?php e(js_escape(lang('permissions_delete_confirm'))); ?>')">
					</td>
				</tr>
			</tfoot>
			<tbody>
