<fieldset>
    <legend><?php echo lang('rp_security'); ?></legend>
    <div class="control-group<?php echo form_error('allow_register') ? $errorClass : ''; ?>">
        <div class="controls">
            <label class='checkbox' for="allow_register">
                ...
                <?php echo lang('rp_allow_register'); ?>
            </label>
    ...
    <div class="control-group<?php echo form_error('user_activation_method') ? $errorClass : ''; ?>">
        <label class="control-label" for="user_activation_method"><?php echo lang('rp_activate_method'); ?></label>
        <div class="controls">
            <select name="user_activation_method" id="user_activation_method">
                <option value="0" <?php echo set_select('auth.user_activation_method', 0, isset($settings['auth.user_activation_method']) && $settings['auth.user_activation_method'] == 0); ?>><?php echo lang('rp_activate_none'); ?></option>
                <option value="1" <?php echo set_select('auth.user_activation_method', 1, isset($settings['auth.user_activation_method']) && $settings['auth.user_activation_method'] == 1); ?>><?php echo lang('rp_activate_email'); ?></option>
                <option value="2" <?php echo set_select('auth.user_activation_method', 2, isset($settings['auth.user_activation_method']) && $settings['auth.user_activation_method'] == 2); ?>><?php echo lang('rp_activate_admin'); ?></option>
            </select>
    ...
    <div class="control-group<?php echo form_error('login_type') ? $errorClass : ''; ?>">
        <label class="control-label" for="login_type"><?php echo lang('rp_login_type') ?></label>
        <div class="controls">
            <select name="login_type" id="login_type">
                <option value="email" <?php echo set_select('auth.login_type', 'email', isset($settings['auth.login_type']) && $settings['auth.login_type'] == 'email'); ?>><?php echo lang('rp_login_type_email'); ?></option>
                <option value="username" <?php echo set_select('auth.login_type', 'username', isset($settings['auth.login_type']) && $settings['auth.login_type'] == 'username'); ?>><?php echo lang('rp_login_type_username'); ?></option>
                <option value="both" <?php echo set_select('auth.login_type', 'both', isset($settings['auth.login_type']) && $settings['auth.login_type'] == 'both'); ?>><?php echo lang('rp_login_type_both'); ?></option>
            </select>
            <span class='help-inline'><?php echo form_error('login_type'); ?></span>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" id="use_usernames_label"><?php echo lang('rp_use_usernames'); ?></label>
        <div class="controls" aria-labelledby="use_usernames_label" role="group">
            ...
            <label class="radio" for="use_email">
                ...
                <?php echo lang('rp_email'); ?>
            </label>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" id='allow_name_change_label'><?php echo lang('rp_display_name'); ?></label>
    ...
    <div class="control-group">
        <div class="controls">
            <label class="checkbox" for="allow_remember">
                ...
                <?php echo lang('rp_allow_remember'); ?>
            </label>
        </div>
    </div>
    <div class="control-group<?php echo form_error('remember_length') ? $errorClass : ''; ?>" id="remember-length"<?php echo $settings['auth.allow_remember'] ? '' : ' style="display:none"'; ?>>
        <label class="control-label" for="remember_length"><?php echo lang('rp_remember_time'); ?></label>
        <div class="controls">
            <select name="remember_length" id="remember_length">
                <option value="604800"  <?php echo set_select('auth.remember_length', '604800', isset($settings['auth.remember_length']) && $settings['auth.remember_length'] == '604800'); ?>>1 <?php echo lang('rp_week'); ?></option>
                <option value="1209600" <?php echo set_select('auth.remember_length', '1209600', isset($settings['auth.remember_length']) && $settings['auth.remember_length'] == '1209600'); ?>>2 <?php echo lang('rp_weeks'); ?></option>
                <option value="1814400" <?php echo set_select('auth.remember_length', '1814400', isset($settings['auth.remember_length']) && $settings['auth.remember_length'] == '1814400'); ?>>3 <?php echo lang('rp_weeks'); ?></option>
                <option value="2592000" <?php echo set_select('auth.remember_length', '2592000', isset($settings['auth.remember_length']) && $settings['auth.remember_length'] == '2592000'); ?>>30 <?php echo lang('rp_days'); ?></option>
            </select>
    ...
    <div class="control-group<?php echo form_error('password_min_length') ? $errorClass : ''; ?>" id="password-strength">
        <label class="control-label" for="password_min_length"><?php echo lang('rp_password_strength'); ?></label>
        <div class="controls">
            ...
            <span class="help-inline"><?php echo (form_error('password_min_length') ? form_error('password_min_length') . '<br />' : '') . lang('rp_password_length_help'); ?></span>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls" aria-labelledby='password_options_label' role='group'>
            <label class="checkbox" for="password_force_numbers">
                ...
                <?php echo lang('rp_password_force_numbers'); ?>
            </label>
            <label class="checkbox" for="password_force_symbols">
                ...
                <?php echo lang('rp_password_force_symbols'); ?>
            </label>
            <label class="checkbox" for="password_force_mixed_case">
                ...
                <?php echo lang('rp_password_force_mixed_case'); ?>
            </label>
            <label class="checkbox" for="password_show_labels">
                ...
                <?php echo lang('rp_password_show_labels'); ?>
            </label>
        </div>
    </div>
    <div class="control-group<?php echo form_error('password_iterations') ? $errorClass : ''; ?>">
        ...
        <div class="controls">
            ...
            <span class="help-inline"><?php echo (form_error('password_iterations') ? form_error('password_iterations') . '<br />' : '') . lang('rp_password_iterations_note'); ?></span>
        </div>
    </div>
    <div class="control-group">
