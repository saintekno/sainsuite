<fieldset>
    <legend><?php echo lang('rp_site_information'); ?></legend>
    <div class="control-group<?php echo form_error('title') ? $errorClass : ''; ?>">
        <label class="control-label" for="title"><?php echo lang('rp_site_name'); ?></label>
        <div class="controls">
    ...
    <div class="control-group<?php echo form_error('system_email') ? $errorClass : ''; ?>">
        <label class="control-label" for="system_email"><?php echo lang('rp_site_email'); ?></label>
        <div class="controls">
            ...
            <span class="help-inline"><?php echo lang('rp_site_email_help'); ?></span>
        </div>
    </div>
    <div class="control-group<?php echo form_error('status') ? $errorClass : ''; ?>">
        <label class="control-label" for="status"><?php echo (form_error('system_email') ? form_error('system_email') . '<br />' : '') . lang('rp_site_status'); ?></label>
        <div class="controls">
            <select name="status" id="status">
                <option value="1" <?php echo set_select('site.status', 1, isset($settings['site.status']) && $settings['site.status'] == 1); ?>><?php echo lang('rp_online'); ?></option>
                <option value="0" <?php echo set_select('site.status', 0, isset($settings['site.status']) && $settings['site.status'] == 0); ?>><?php echo lang('rp_offline'); ?></option>
            </select>
    ...
    <div class="control-group<?php echo form_error('list_limit') ? $errorClass : ''; ?>">
        <label class="control-label" for="list_limit"><?php echo lang('rp_top_number'); ?></label>
        <div class="controls">
            ...
            <span class="help-inline"><?php echo (form_error('list_limit') ? form_error('list_limit') . '<br />' : '') . lang('rp_top_number_help'); ?></span>
        </div>
    </div>
    <div class="control-group<?php echo form_error('languages') ? $errorClass : ''; ?>">
        <label class="control-label" for="languages"><?php echo lang('rp_language'); ?></label>
        <div class="controls">
            ...
            <span class="help-inline"><?php echo (form_error('languages') ? form_error('languages') . '<br />' : '') . lang('rp_language_help'); ?></span>
        </div>
    </div>
</fieldset>