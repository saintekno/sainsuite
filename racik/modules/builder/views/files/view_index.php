			...
			<tfoot>
				...
				<tr>
					<td colspan='<?php echo \$num_columns; ?>'>
						...
						<input type='submit' name='delete' id='delete-me' class='btn btn-danger' value=\"<?php echo lang('rp_action_delete'); ?>\" onclick=\"return confirm('<?php e(js_escape(lang('{$module_name_lower}_delete_confirm'))); ?>')\" />
					</td>
				</tr>
				<?php endif; ?>
			</tfoot>
