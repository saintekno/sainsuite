	...
	<table class="table table-striped">
		<thead>
			<tr>
				...
				<th><?php echo lang('rp_actions'); ?></th>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				...
				<td>
					<?php echo form_open(SITE_AREA . '/developer/builder/delete'); ?>
						...
						<input type="submit" class="btn btn-danger" onclick="return confirm('<?php e(js_escape(lang('mb_delete_confirm'))) ?>');" value="<?php e(lang('rp_action_delete')) ?>" />
					<?php echo form_close(); ?>
				</td>
			</tr>
		<?php endforeach; ?>
