...
class Installer
{
    ...
    public function is_installed()
    {
        ...
        defined('RP_INSTALLED') || define('RP_INSTALLED', true);
    ...
    public function setup()
    {
        ...
        $this->ci->load->library(
            ...
            array('migrations_path' => RPPATH . 'migrations')
        );

        // Core Migrations - this is all that is needed for racik install.
        ...
        $settings = array(
            'site.title'        => 'Racik',
            'site.system_email' => 'admin@racikproject.com',
        );
        ...
        $data = array(
            'role_id'  => 1,
            'email'    => 'admin@racikproject.com',
            'username' => 'admin',
            'active'   => 1,
        );

        // As of 0.7, using phpass for password encryption...
        require(RPPATH . 'modules/users/libraries/PasswordHash.php');
