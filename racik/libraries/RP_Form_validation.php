 ...
 * functionality used in Racik.
 */
class RP_Form_validation extends CI_Form_validation
{
    /**
    ...
    {
        $this->CI->lang->load('form_validation_rp');
    ...
    public function allowed_types($str, $types = null)
    {
        if (! $types) {
            ...
            $this->CI->form_validation->set_message('allowed_types', lang('rp_form_allowed_types_none'));
            return false;
        }
        ...
        $this->CI->form_validation->set_message('allowed_types', lang('rp_form_allowed_types'));
        return false;
    }
    ...
    public function alpha_extra($str)
    {
        ...
        $this->CI->form_validation->set_message('alpha_extra', lang('rp_form_alpha_extra'));
        return false;
    }
    ...
    public function matches_pattern($str, $pattern)
    {
        ...
        $this->CI->form_validation->set_message('matches_pattern', lang('rp_form_matches_pattern'));
        return false;
    }
    ...
    public function max_file_size($str, $size = 0)
    {
        if (empty($size)) {
            ...
            $this->CI->form_validation->set_message('max_file_size', str_replace('{max_size}', '0', lang('rp_form_max_file_size')));
            return false;
        }
        ...
        $this->CI->form_validation->set_message('max_file_size', str_replace('{max_size}', $size, lang('rp_form_max_file_size')));
        return false;
    }
    ...
    public function one_of($str, $options = null)
    {
        if (! $options) {
            ...
            $this->CI->form_validation->set_message('one_of', lang('rp_form_one_of_none'));
            return false;
        }
        ...
        $this->CI->form_validation->set_message('one_of', lang('rp_form_one_of'));
        return false;
    }
    ...
    public function unique($value, $params)
    {
        ...
        if ($query->row()) {
            $this->CI->form_validation->set_message('unique', lang('rp_form_unique'));
            return false;
        }
    ...
    public function valid_password($str)
    {
        ...
        if (strlen($str) < $min_length) {
            $this->CI->form_validation->set_message('valid_password', str_replace('{min_length}', $min_length, lang('rp_form_valid_password')));
            return false;
        }

        // Check numbers
        if ($use_nums && 0 === preg_match('/[0-9]/', $str)) {
            $this->CI->form_validation->set_message('valid_password', lang('rp_form_valid_password_nums'));
            return false;
        }

        // Check symbols
        if ($use_syms && 0 === preg_match('/[!@#$%^&*()._]/', $str)) {
            $this->CI->form_validation->set_message('valid_password', lang('rp_form_valid_password_syms'));
            return false;
        }
        ...
        if ($use_mixed) {
            if (0 === preg_match('/[A-Z]/', $str)) {
                $this->CI->form_validation->set_message('valid_password', lang('rp_form_valid_password_mixed_1'));
                return false;
            }

            if (0 === preg_match('/[a-z]/', $str)) {
                $this->CI->form_validation->set_message('valid_password', lang('rp_form_valid_password_mixed_2'));
                return false;
            }
        }
