...
<div class="flex-column justify-content-lg-start text-white d-none d-lg-flex px-40">
    ...
    <?php echo $this->events->apply_filters( 'fill_dash_footer_copyright', ( $copyright = riake('copyright', options())) ? sprintf( __( 'Copyright © %s %s.' ), date('Y'), $copyright ).' All rights reserved' : sprintf( __( 'Version %s' ), get('version') ) );?>
    </p>
</div>