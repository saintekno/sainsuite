...
if (isset($shortcut_data) && is_array($shortcut_data['shortcut_keys'])) {
    Assets::add_js($this->load->view('display/shortcut_keys', $shortcut_data, true), 'inline');
}
...
<body class="desktop">
    ...
    <![endif]-->
	<noscript>
		<p>Javascript is required to use Racik's admin.</p>
	</noscript>
        ...
        <div class="navbar-inner">
            <div class="container">
                ...
                <div class="nav pull-right" id="shortcuts">
                        ...
                        <ul class="dropdown-menu pull-right toolbar-keys">
                            <li>
                                <div class="inner keys">
                                    <h4><?php echo lang('rp_keyboard_shortcuts'); ?></h4>
                                    <ul>
				    ...
				    <?php if ( has_permission('Racik.Display.View') && has_permission('Racik.Display.Manage') ): ?>
                                    <a href="<?php echo site_url(SITE_AREA . '/settings/display'); ?>"><?php echo lang('rp_keyboard_shortcuts_edit'); ?></a>
				    <?php endif; ?>
                                </div>
                            </li>
						</ul>
                ...
                <div class="nav-collapse in collapse">
                    ...
                    <div class="nav pull-right" id="user-menu">
                        <div class="btn-group">
                            <a href="<?php echo site_url('users/profile'); ?>" id="tb_email" class="btn dark" title="<?php echo lang('rp_user_settings'); ?>">
                                <?php
                                ...
                                <li>
                                    <div class="inner">
                                        ...
                                        <div class="toolbar-profile-info">
                                            ...
                                            <a href="<?php echo site_url(SITE_AREA . '/settings/users/edit'); ?>"><?php echo lang('rp_user_settings'); ?></a>
                                            <a href="<?php echo site_url('logout'); ?>"><?php echo lang('rp_action_logout'); ?></a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
