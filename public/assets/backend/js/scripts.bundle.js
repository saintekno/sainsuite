...
var KTLayoutAsideToggle = function() {
	...
	var _init = function() {
		...
		_toggleObject.on('beforeToggle', function(toggle) {
			if (KTUtil.hasClass(_body, 'aside-minimize') === false) {
...
var KTLayoutAside = function() {
    ...
    var menuAside = function(){
        ...
        var menuToggle = localStorage.getItem("menuToggle");
        ...
        // kt_header
        $('#kt_header').on('click', '.navheader-nav a', function(e) {
            var $this = $(this);
            var linkId = $this.attr('href');
...
var KTLayoutChat = function () {
	...
	return {
		init: function() {
			...
			if (encodeURI(window.location.hostname) == 'example.com' || encodeURI(window.location.hostname) == 'www.example.com') {
				setTimeout(function() {
