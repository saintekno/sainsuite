				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group has-feedback">
							<label for="_ht_name"><?php echo __( 'Host Name' );?></label>
						...
						<div class="form-group has-feedback">
							<label for="_db_name"><?php echo __( 'Database Name' );?></label>
						...
						<div class="form-group has-feedback">
							<label for="_db_pref"><?php echo __( 'Database Prefix' );?></label>
							<input type="text" name="_db_pref" class="form-control" placeholder="<?php _e('Database Prefix');?>" value="<?php echo set_value('_db_pref', 'rck_'); ?>">
							<span class="glyphicon glyphicon-log-in form-control-feedback"></span>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group has-feedback">
							<label for="_uz_name"><?php echo __( 'User Name' );?></label>
						...
						<div class="form-group has-feedback">
							<label for="_uz_pwd"><?php echo __( 'User Password' );?></label>
						...
						<div class="form-group has-feedback">
							<label for="_db_driv"><?php echo __( 'Database Driver' );?></label>
