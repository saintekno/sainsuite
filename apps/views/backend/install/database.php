...
<form method="post" class="form" autocomplete="off" >
	...
	<div class="row">
		...
		<div class="col-xl-6">
			<!--begin::Select-->
			<div class="form-group">
				<select name="_db_driv" placeholder="<?php _e('Database Driver');?>" class="form-control form-control-solid h-auto font-size-h5 p-5 border-0 rounded-lg font-size-h6">
