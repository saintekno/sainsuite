...
<form method="post" autocomplete="off" id="kt_login_singin_form" class="form required-form">
    ...
    <!--begin::Form group-->
    <div class="form-group fv-plugins-icon-container">
        <input class="form-control form-control-solid h-auto font-size-h5 p-6 border-0 rounded-lg font-size-h6" type="password" placeholder="<?php _e('Password' ); ?>" name="password" required>
    </div>
    <!--end::Form group-->

    <!--begin::Form group-->
    <div class="form-group fv-plugins-icon-container">
        <input class="form-control form-control-solid h-auto font-size-h5 p-6 border-0 rounded-lg font-size-h6" type="password" placeholder="<?php _e('Confirm' ); ?>" name="confirm" required>
    </div>
    <!--end::Form group-->
