<div class="list-group">
    ...
    {
        echo Do_info( __( 'Click on any key to revoke it' , 'aauth') );
        foreach( $apps as $app ) 
        {
            $app = (array)$app; ?>
        ...
        <a href="#" class="list-group-item">
            ...
            <?php echo __( 'No application is linked to this account.' , 'aauth');?>
        </a>
        <?php
    }
    ?>
        ...
        bootbox.confirm( '<?php echo __( 'Would you like to revoke this App key ?' , 'aauth');?>', function( action ){
            if( action ) {
                $.ajax({
                    url : $this.attr( 'href' ),
                    success : function(){
                        $this.closest( '.list-group-item' ).fadeOut( 500, function(){
                            $(this).closets( 'li' );
                        })
                    },
                    method : 'DELETE'
