...
$lang['aauth_email_verification_subject'] = __('Eracik : Account Verification', 'aauth');
$lang['aauth_email_verification_code'] = __('Hey you have successfully created an account using Eracik. Please consider activating your account using the following verification code.\n\n<strong>Your verification code is</strong>: ', 'aauth');
...
// Password reset
$lang['aauth_email_reset_subject'] = __('Eracik : Reset Password', 'aauth');
...
$lang['aauth_email_reset_success_subject'] = __('Eracik : Successful Pasword Reset', 'aauth');
...
$lang[ 'group-updated' ]            =    Do_success(__('The group has been updated', 'aauth'));
...
$lang[ 'fetch-error-from-auth' ]        =    function () {
    ...
    foreach ($errors_array as $_error) {
        echo Do_error($_error);
    }

    foreach ($notice_array as $notice) {
        echo Do_error($notice);
    }};
// User Edition
$lang[ 'user-updated' ]                    =    Do_success(__('User settings\'s has been updated.', 'aauth'));
$lang[ 'user-deleted' ]                    =    Do_success(__('The user has been deleted.', 'aauth'));
$lang[ 'pass-change-error' ]            =    Do_error(__('The new password cannot match the old one, please use another password.', 'aauth'));
$lang[ 'old-pass-incorrect' ]            =    Do_error(__('Your old password is not correct.', 'aauth'));

// Group
$lang[ 'group-already-exists' ]        =    Do_error(__('A group with this name already exists. Please choose another name.', 'aauth'));
$lang[ 'group-deleted' ]                    =    Do_success(__('The group has been deleted.', 'aauth'));
$lang[ 'group-created' ]                =    Do_success(__('Group has been created.', 'aauth'));
$lang[ 'group-not-found' ]                =    Do_error(__('This group does\'nt exists or has been deleted.', 'aauth'));
$lang[ 'unknow-group' ]                    =    Do_error(__('Unknow group.', 'aauth'));
$lang[ 'updated' ]                        =    Do_success(__('Group has been updated.', 'aauth'));
$lang[ 'cant-delete-yourself' ]			=	Do_error( __( 'You can\'t delete your own  account.', 'aauth' ) );
