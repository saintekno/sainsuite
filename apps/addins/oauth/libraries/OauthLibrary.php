...
class OauthLibrary
{
    ...
    **/
    ...
    {
        $Cache      =   new CI_Cache( array('adapter' => 'apc', 'backup' => 'file', 'key_prefix' => 'Do_' ) );
    ...
    **/
    ...
    public function checkScope($endpoint_scope)
    {
        ...
        **/
        ...
        get_instance()->load->addin_config('restful', '_rest');
        ...
        if ( ! in_array( $endpoint_scope, $app_scopes ) ) {
            ...
            if( ENABLE_DEBUG ) {
                file_put_contents( APPPATH . 'logs/scope-failed.txt', json_encode([
                    'scopes'    =>  $app_scopes,
                    'key'       =>  $query
                ]));
            }
