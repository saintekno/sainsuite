 ...
 * @version         3.0.0
 */
abstract class REST_Controller extends Eracik_Controller
{
     ...
     * @return void
     */
    public function __construct($module= 'restful', $config = '_rest')
    {
        parent::__construct();
        ...
        $this->lang->load_lines('../modules/codeigniter_restserver/language/' . $language . '/*.php');
